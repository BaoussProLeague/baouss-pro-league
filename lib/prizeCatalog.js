...
export const PRIZE_CATALOG = [
  ...
  },
  {
    ...
    status: "live",
    description:
      "Whoever climbs the most places in the mini-league table between the end of GW19 and the end of the season wins - the biggest second-half turnaround. Only managers finishing in the top half of the final Classic table are eligible, so a comeback still has to end somewhere respectable to count.",
  },
  {
  ...
  },
  {
    ...
    status: "live",
    description:
      "Measures the payoff of a Wildcard, not just the week it's played: total points across the Wildcard gameweek and the four that follow. Rewards a squad built to last, not just spike for one week. Best of your two Wildcard windows this season.",
  },
  {
    key: "defGk",
    ...
    status: "admin",
    description:
      "Whoever's Defenders and Goalkeepers - bench included - have contributed the most points to their total across the season. Tracked from whenever the admin first runs this check; earlier gameweeks aren't backfilled.",
  },
  {
    key: "rankJumpMonth",
    ...
    status: "live",
    description:
      "For each calendar month, whoever climbs the most places in the mini-league table - measured against each other, not against the whole of FPL - takes that month's prize.",
  },
  {
    key: "motm",
